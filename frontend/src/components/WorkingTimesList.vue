...
import CalendarBlock from './CalendarComponent/CalendarBlock.vue'
import NewWorkingTime from './CalendarComponent/NewWorkingTime.vue'
...
export default {
  ...
  components: {
    ...
    watch: {
      /*getUserConnectedID(ancien, nouveau) {
    ...
    methods: {
      getWorkingTimesUser: function() {
        if (this.$store.state.userConnected.isConnected === true) {
          ...
          .then(json => {
            console.log('RESULLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLTTTTTTTTTTTTTTTTTTTTTTTTTTT')
            console.log(json);
