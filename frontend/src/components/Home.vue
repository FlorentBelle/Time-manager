...
<template >
  ...
  <div class="card-menu-container">
    ...
    <div class="card-menu">
      ...
      <p class="card-menu-description"> Current Time : <br>{{this.startedFrom.hours - 1}} : {{this.startedFrom.minutes}} : {{this.startedFrom.seconds}}</p>
      <p class="card-menu-description" v-if="clock.status === true">
      ...
      <p class="card-menu-description" v-if="clock.status === true"> {{ this.startedWithClock.hours - 1 - this.hours}} : 
        {{(this.startedWithClock.minutes - this.minutes < 0 ? 60 + this.startedWithClock.minutes - this.minutes : this.startedWithClock.minutes - this.minutes)}} : 
        {{
          (this.startedWithClock.seconds - this.seconds < 0 ? (this.startedWithClock.seconds - this.seconds) * -1 : this.startedWithClock.seconds - this.seconds)
    ...
    <div class="card-menu">
      ...
      <RouterLink :to="'/users/' + this.$store.state.userConnected.id">
        <button class="card-menu-button">Go to</button>
      </RouterLink>
    </div>
    </div>
      ...
      data: function() {
        ...
        methods: {
          ...
          .then(json => {
            ...
            this.seconds = json.content.time.split('T')[1].split(':')[2].slice(0, -1);
